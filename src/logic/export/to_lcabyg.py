...
from .utils import query_project_for_export, query_assemblies_for_export
                    ...
                    if assembly["id"] == element.assembly_id:
                        for layer in assembly.get("layers", []):
                            ...
                            for phase in ["A1to3", "C3", "C4", "D"]:
                                ...
                                entity_list.extend([phase_node, create_edge(phase_node, layer_node), #])
                                                    create_edge(phase_node)])
